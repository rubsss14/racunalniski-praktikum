...
\begin{figure}[!ht]
   \centering
   \includegraphics[scale=1.0]{slika.pdf}
   \caption{Prikaz magičnega kvadrata}
   \label{fig:slika}
\end{figure}
...
\begin{table}[h]
\centering
\caption{Dürerjev magični kvadrat $4\times4$}
\label{table:durer}
...
\begin{figure}[!ht]    
   \centering              
   \includegraphics[scale=1.0]{sagrada.png} 
...
\begin{izrek}
   Magična konstanta normalnega magičnega kvadrata reda 3
   je enaka
   \begin{equation}
      % oznaka: eq:mc
...
!!
Kvadratu v tabeli \ref{ttable:closhu} ustrezata konstanti $A=20$ in $D=1$.
